...
airway_all = combine(PAGES[47], PAGES[48])
...
details = {
    ...
    "airway-management": {
        "polytrauma": [
            airway_all,
            combine(
                section(PAGES[48], "13. Kembangkan ambu bag", None),
                "Konfirmasi posisi menggunakan waveform capnography bila tersedia, pengembangan dada bilateral, auskultasi epigastrium dan kedua paru, serta fiksasi pipa.",
            ),
            "Menilai prioritas ABC, stabilisasi servikal, kehati-hatian, pembatasan durasi percobaan intubasi, reoksigenasi, dan kemampuan meminta bantuan.",
        ]
    },
}
